...
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/team/domainMapping.ts` | action=completed | contract=canonical | note=`nuovo resolver condiviso del dominio canonico/runtime degli agenti, con supporto a preferredDomain, fallbackDomain e primaryDomain`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/types.ts` | action=completed | contract=canonical | note=`AgentProfile esteso con primaryDomain opzionale per disambiguare agenti multi-dominio`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/team/schema.ts` | action=completed | contract=canonical | note=`schema dei profile team aggiornato per accettare primaryDomain`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/team/loader.ts` | action=completed | contract=canonical | note=`loader team riallineato a primaryDomain e generic fallback agent marcato general`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/TEAM/allenamento/coach-del-sonno/profile.json` | action=completed | contract=canonical | note=`sleep-coach dichiara primaryDomain mindfulness per evitare mapping implicito dal primo tag`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/app/api/chat/send/route.ts` | action=completed | contract=canonical | note=`thinking events production-facing non deducono piu` il dominio dal primo tag ma dal resolver canonico runtime`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/app/api/chat/send/chatStream.ts` | action=completed | contract=canonical | note=`fallback thinking events allineati al mapping canonico per gli specialisti multi-dominio`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/case/compat.ts` | action=completed | contract=canonical | note=`deriveActiveSpecialistFromCaseState usa il dominio del lead panel quando supportato dallo specialista`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/case/events.ts` | action=completed | contract=canonical | note=`case protocol thinking events usano il resolver canonico dominio-specialista`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/case/protocol.ts` | action=completed | contract=canonical | note=`getCaseRoutingDomain evita il fallback ambiguo a domainTags[0]`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/consensus/domainResolver.ts` | action=completed | contract=canonical | note=`enforceDomainIsolation normalizza solo domini davvero non supportati, non comprime i multi-dominio a un tag arbitrario`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/orchestrator/agentExecution.ts` | action=completed | contract=canonical | note=`budget context pack per-agent allineato al dominio runtime canonico invece del primo tag`
2026-03-28 00:13 | step=CP-63 | file=`/Users/mattiamottisi/Desktop/LiveWell/src/lib/ai/orchestrator/contextualQuickReplies.ts` | action=completed | contract=canonical | note=`quick replies contestuali basate sull'ultima domanda utile, deduplicate e fail-closed sulle domande composte`

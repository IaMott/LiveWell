...
interface MessageListProps {
  ...
  isStreaming?: boolean
  /** When set, shows a TypingIndicator attributed to the streaming specialist */
  streamingSpecialistName?: string
  className?: string
}

export function MessageList({ messages, isStreaming, streamingSpecialistName, className }: MessageListProps) {
  ...
  const showTyping =
    (streamingSpecialistName !== undefined || isStreaming) &&

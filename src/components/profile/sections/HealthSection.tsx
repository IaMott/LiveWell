...
export function HealthSection({ data }: Props) {
  ...
  const hasData = stats.lastWeightEntry != null
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <Field label="Patologie croniche / condizioni">
              <textarea
                ...
                placeholder="es: ipertensione, diabete tipo 2, asma…"
                rows={2}
            ...
            <Field label="Farmaci in uso">
              <textarea
                ...
                placeholder="es: metformina 500mg, ramipril 5mg…"
                rows={2}
                style={{ ...inputStyle, resize: 'vertical' }}
              />
            </Field>
            <Field label="Interventi chirurgici pregressi">
              <input
                ...
                placeholder="es: appendicite (2015), menisco (2020)"
                style={inputStyle}
              />
            </Field>

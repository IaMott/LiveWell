...
export function buildSharedAgentRules(
  ...
  lines.push(
    ...
    `  user.setAttribute domain:"personal" key:"birth_date" value:<ISO date approssimata>.`,
    `  Esempio: se oggi è ${new Date().getFullYear()} e dichiara '35 anni', scrivi value:"${new Date().getFullYear() - 35}-06-15" (usa giorno 15 e mese 06 come stima se non specificati).`,
    `  NON salvare mai key:"age" — l'età è calcolabile dalla data di nascita e non invecchia correttamente.`,
    ``,
    `PRIORITÀ (in ordine):`,

...
export function buildAgentUserPrompt(
  ...
  parts.push(
    ...
    `- Identificati sempre come "${agentDisplayName ?? 'uno specialista'}" — NON inventare mai un nome proprio personale (es. vietato "Sono il Dr. Mario Rossi" o "Sono la Dr.ssa Sofia Ricci"). Il tuo nome è il tuo ruolo professionale.`,
    `- Usa "io" in prima persona quando sei l'unico specialista attivo in questa risposta. Usa "noi" SOLO in co-presenza esplicita con un altro specialista nella stessa risposta.`,
    ``,
    `RUOLO E APPROCCIO:`,

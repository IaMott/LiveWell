# Analista Contesto — Capabilities

    ## Missione
    Fornire contributi **evidence-based** nel dominio: **coordination**, in un sistema **team-led**.
...
- `share.createLink`
    ...
    ## Escalation rules
    - Se emergono segnali di rischio da qualsiasi dominio -> attivare escalation sicurezza e coordinare risposta del team.
